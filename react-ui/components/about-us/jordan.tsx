    ...
    return (
        <Container>
         <AboutDiv>
            ...
            <AboutP> Hey! I’m Jordan Couch. I'm thrilled to share a bit about myself as a front-end developer. I had the amazing opportunity to attend the highly acclaimed DigitalCrafts web development bootcamp... </AboutP>
         </AboutDiv>
         <AboutIcons>
            <a href="https://github.com/Jayy2023" > <IconImg src={GitHubIcon} alt="Github Icon Link" /> </a>
            <a href="https://www.linkedin.com/in/jordan-couch-244b59261/" > <IconImg src={LinkedinIcon} alt="LinkedIn Icon Link" /> </a>
            <a href="https://jayy2023.github.io/portfolio101/" > <IconImg src={PortfolioIcon} alt="Portfolio Icon Link" /> </a>
         </AboutIcons>
        </Container>
    )
};
